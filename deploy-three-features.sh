...
# 🚀 部署三大核心功能
# Summarize + Find Skills + Skill Vetter
...
# 2. 添加执行权限
echo "🔧 添加执行权限..."
chmod +x "$WORKSPACE/summarize.js"
chmod +x "$WORKSPACE/find-skills.js"
chmod +x "$WORKSPACE/skill-vetter.js"
echo "  ✅ 权限已设置"
...
echo ""
echo "  测试 Summarize..."
node "$WORKSPACE/summarize.js" --help 2>/dev/null || node "$WORKSPACE/summarize.js" 2>&1 | head -5

echo ""
echo "  测试 Find Skills..."
node "$WORKSPACE/find-skills.js" --help 2>/dev/null || node "$WORKSPACE/find-skills.js" 2>&1 | head -5

echo ""
echo "  测试 Skill Vetter..."
node "$WORKSPACE/skill-vetter.js" --help 2>/dev/null || node "$WORKSPACE/skill-vetter.js" 2>&1 | head -5

echo ""

# 4. 创建使用文档
echo "📝 创建使用文档..."
cat > "$WORKSPACE/THREE-FEATURES-GUIDE.md" << 'EOF'
# 🎯 三大核心功能使用指南
...
echo "  ✅ THREE-FEATURES-GUIDE.md 已创建"
...
echo "💾 提交到 Git..."
cd "$WORKSPACE"
git add summarize.js find-skills.js deploy-three-features.sh THREE-FEATURES-GUIDE.md
git commit -m "feat: 部署三大核心功能

📝 Summarize - 文档/网页/音视频摘要神器
🔍 Find Skills - 懒人专属技能导航仪  
🛡️ Skill Vetter - 安全防护神器
...
echo ""
echo "📚 查看使用文档:"
echo "   cat THREE-FEATURES-GUIDE.md"
echo ""
echo "🎯 立即使用:"
echo "   /summarize <文件|URL>"
echo "   /find <关键词>"
echo "   /vet <技能文件>"
echo "━━━━━━━━━━━━━━━━━━━━"
